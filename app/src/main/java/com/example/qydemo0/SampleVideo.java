...
public class SampleVideo extends StandardGSYVideoPlayer {
    ...
    private Boolean is_double = true;

    private String mTypeText = "1080P";
    ...
    public void setIs_double(Boolean isi){
        this.is_double = isi;
    }
    ...
    private void initView() {
        ...
        mSpeed = (TextView) findViewById(R.id.change_speed);
