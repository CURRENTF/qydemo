...
import com.example.qydemo0.ClipImageActivity;
import com.example.qydemo0.ImageSelectorActivity;
...
public class ImageSelector {
    ...
    public static class ImageSelectorBuilder {
         ...
         * @param requestCode
         */
        public Intent start(Activity activity, int requestCode) {
            ...
            if (config.isCrop) {
                ...
                return ImageSelectorActivity.openActivity(activity, requestCode, config);
            }
            return null;
        }
