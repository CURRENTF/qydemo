...
public class GameActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        initUI();
        if(mode == 0){
            new getTZImageList().execute(Integer.valueOf(params.get(1)));
        }
    ...
    private void initKqw(){
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if(date.equals("【打开】镜子") || date.equals("【关闭】镜子")){
                    btn_mirrors();
...
//            cur_img_list.add("https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2333542448,1545334133&fm=26&gp=0.jpg");
    ...
    public class canInDataBase extends AsyncTask<Void, Void, List<String> >{
    ...
    public class FinishTZ extends AsyncTask<Integer, Void, List<String> >{

        @Override
        protected List<String> doInBackground(Integer... voids) {
            //发送挑战模式分数 voids[0]
            return null;
        }
